...
public class VendingMachineMessagesTest {
    ...
    @Test
    public void should_build_warning_message_with_cause() {
        String problem = "tests";
        int subject = 1;
        String expectedMessage = "WARN: " + problem + " [" + subject + "]";
        Assert.assertEquals(expectedMessage, VendingMachineMessages.buildWarningMessageWithCause(problem, subject));
    }
}
